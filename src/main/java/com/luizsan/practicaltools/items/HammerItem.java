...
public class HammerItem extends PickaxeItem implements IAoeTool {
    ...
    protected HammerItem(Tier tier, int attackDamageIn, float attackSpeedIn, Properties builder, Ingredient customRepair) {
    ...
    public boolean mineBlock(ItemStack stack, Level world, BlockState state, BlockPos pos, LivingEntity entityLiving) {
        stack.hurt(ModConfig.COMMON.hammerDuraLossMulti.get()-1, ModConfig.random, null);
